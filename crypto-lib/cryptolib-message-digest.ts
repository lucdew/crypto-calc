...
var messageDigestType: Cryptolib.MessageDigest.IMessageDigestTypeStatic = {
...
var messageDigest:Cryptolib.MessageDigest.IMessageDigestStatic = {
	
	digest: (messageDigest:Cryptolib.MessageDigest.IMessageDigestType,data:Buffer)=> {
