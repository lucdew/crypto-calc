...
export class AppController {
  ...
  public static Factory() {
    ...
    let controller = ($router:any,$scope:ng.IScope,$location:ng.ILocationService,sendToMenuService:ISendToMenuService) => new AppController($router,$scope,$location,sendToMenuService);
