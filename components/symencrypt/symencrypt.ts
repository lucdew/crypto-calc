...
function SymencryptController($timeout: angular.ITimeoutService, cryptolib: Cryptolib.CryptoLibStatic,
                                sendToMenuService: CryptoCalcModule.ISendToMenuService, $scope) {
