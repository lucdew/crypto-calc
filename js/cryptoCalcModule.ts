...
module CryptoCalcModule {
    ...
    export var cryptoCalcModule = angular.module('CryptoCalcModule', ['ngNewRouter', 'CryptoCalcModule.symencrypt',
        'CryptoCalcModule.asymmetric', 'CryptoCalcModule.banking', 'CryptoCalcModule.digest', 'CryptoCalcModule.utils'
    ]);
    ...
    cryptoCalcModule.controller('AppController', ['$router', '$scope', '$location', 'SendToMenuService', AppController]);
    ...
    function AppController($router: any, $scope: any, $location: angular.ILocationService, sendToMenuService: ISendToMenuService) {
        var self = this;
