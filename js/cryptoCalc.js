...
(function (CryptoCalcModule) {
    ...
    CryptoCalcModule.cryptoCalcModule = angular.module('CryptoCalcModule', ['ngNewRouter', 'CryptoCalcModule.symencrypt',
    ...
    CryptoCalcModule.cryptoCalcModule.controller('AppController', ['$router', '$scope', '$location', 'SendToMenuService', AppController]);
    ...
    function AppController($router, $scope, $location, sendToMenuService) {
        var self = this;
